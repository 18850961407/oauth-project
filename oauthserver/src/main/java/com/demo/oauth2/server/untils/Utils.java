...
public final class Utils {
    ...
    private void setServletContext(ServletContext ctx) {
        ...
        redirectUri = "http://localhost:8901" + contextPath + "/test";
    }
    ...
    public void validateAuthorizationParams(OauthParam oauthParams) throws ApplicationException  {
    ...
    public void validateTokenParams(OauthParam oauthParams) throws ApplicationException {
